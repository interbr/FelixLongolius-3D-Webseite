 ...
 */
 ...
 // Application Options
 option.appDefaultName       = "tCupSpace";                    // The default application a connection belongs to if it is not initially specified.
 ...
 option.sessionCookieEnable  = false;                         // If enabled, the server will attempt to send a easyrtcsid cookie which matches the Express session id.
