...
if ($_POST["doing"] == 1) {
  ...
  $fleo_pdo->exec("UPDATE `$room` SET `audioStationText`='$content', `robotData`='$robotData', `tick` = tick+1, `tick2`=tick+1, `ip`=concat(`ip`, ', $fleoip') WHERE `whatIsThis`='1672879342grafikpn140054396767.png.webp'");
  echo "done.";
      }
    }