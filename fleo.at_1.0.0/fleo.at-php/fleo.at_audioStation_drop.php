...
if (isset($_POST['clerkText'])) {
  $cleText = ($_POST["clerkText"]); $cleColor = "white"; } 
else if (isset($_POST['cleggText'])) { 
  $cleText = ($_POST["cleggText"]); $cleColor = "#FADADD"; } 
else { $cleText= "..."; }
$cleText=addslashes($cleText);
$cleText=htmlspecialchars($cleText); 
if (isset($_POST['whatIsThis'])) { $whatIsThis = ($_POST["whatIsThis"]); } else { $whatIsThis = "audStat" . random_int(0,99999999); }
if (isset($_POST['buildhtml'])) { $buildhtml = ($_POST["buildhtml"]); } else { $buildhtml = '<audio class="audioStation" id="' . $whatIsThis . '" src="https://popular.gb.fleo.at/' . $popularUrl . '"></audio><div id="audioStationAudioDiv-' . $whatIsThis . '" class="audioStationAudioDiv-' . $whatIsThis . '" style="width:140px;height:140px;border:16px solid #ffffff00;text-align:center;position:absolute;bottom:350px;left:24px;pointer-events:auto;overflow:visible;"><div class="audioStationAudioPlay-' . $whatIsThis . '" style="cursor:pointer;"><img src="/fleo.at-js/push2Talk/fleoPlay.webp" style="position:absolute;top:0;left:0;width:100%;height:100%;" alt="fleo.Controls Play" /></div><div class="audioStationAudioStop-' . $whatIsThis . '" style="display:none;cursor:pointer;"><img src="/fleo.at-js/push2Talk/fleoStop.webp" style="position:absolute;top:0;left:0;width:100%;height:100%;" alt="fleo.Controls Stop" /></div></div><div id="audioStationText-' . $whatIsThis . '" style="font-weight:bold;pointer-events:auto;width:400px;left:-100px;background:' . $cleColor . ';border:4px solid black;height:auto;min-height:140px;overflow:visible;" contenteditable="true">' . $cleText . '</div><div id="letterCoinMillAudioStationTextLettercoin-1-' . $whatIsThis . '" style="position:absolute;margin:auto;display:flex;align-items:center;justify-content:center;bottom:0;height:56px;left:18px;width:56px;border:2px solid gray;border-radius:30px;overflow:hidden;padding:0px;font-size:56px;text-align:center;font-family:Courier,monospace;color:yellow;"></div><div id="letterCoinMillAudioStationTextLettercoin-2-' . $whatIsThis . '" style="position:absolute;margin:auto;display:flex;align-items:center;justify-content:center;bottom:0;height:56px;left:138px;width:56px;border:2px solid gray;border-radius:30px;overflow:hidden;padding:0px;font-size:56px;text-align:center;font-family:Courier,monospace;color:yellow;"></div>' . '<img src="/fleo.at-medien/audioStation_I.webp" style="width:216px;height:704px;pointer-events:none;" class="audioStationImg" alt="audioStation" />'; }
