...
<div>
<div style="position:relative;width:700px;height:0;overflow:visible;"><div id="audioStationTextContainer" style="position:absolute;top:0;left:0;width:700px;height:0;color:black;overflow:visible;"></div></div>
</div>
...
<p><div><label for="buildjavascript" class="form">javascript </label>
...
<p><div class="" style=""><label for="buildcoords" class="form">Coords: </label><input type="text" name="buildcoords" value="<?php echo $_GET["buildcoords"]; ?>"></div></p>
<p><div class="" style=""><label for="builddoords" class="form">Doords: </label><input type="text" name="builddoords" value="<?php echo $_GET["builddoords"]; ?>"></div></p>
</div>
...
<div style="float:left;width:100%;max-width:500px;min-width:200px;padding:4px;background:#47ccf06f;display:none;">
...
<div style="float:left;width:100%;max-width:500px;padding:4px;background:#ffffff6f;font-size:30px;display:none;">Hit the red button to send your recording.</div>
