...
$get_fragile = $fleo_pdo->prepare("SELECT `whatIsThis`, `onOff`, `coordsW`, `coordsH`, `coordsD`, `isRobot`, `go`, `program`, `isOnline` FROM `room-home` WHERE `whatIsThis` = '1721478796imagepngcd5bd27555eed701973bf72e77d8226f.png.webp';"); 

$get_fragile->execute(); 
$row = $get_fragile->fetch();

if ($row["isOnline"] == 1) {
    $fleo_pdo->exec("UPDATE `room-home` SET `isOnline` = 3, `program` = '$meIam' WHERE `whatIsThis` = '1721478796imagepngcd5bd27555eed701973bf72e77d8226f.png.webp';");
}
...
if (isset($_GET["carNewCoordsW"]) && isset($_GET["carNewCoordsD"])) {
    ...
    $fleo_pdo->exec("UPDATE `room-home` SET `isOnline` = 1, `program` = '$meIam', `coordsW` = '$carNewCoordsW', `coordsD` =  '$carNewCoordsD' WHERE `whatIsThis` = '1721478796imagepngcd5bd27555eed701973bf72e77d8226f.png.webp';");
    ...
    $get_fragile = $fleo_pdo->prepare("SELECT `whatIsThis`, `onOff`, `coordsW`, `coordsH`, `coordsD`, `isRobot`, `program`, `isOnline`, `minusPlusW` FROM `room-home` WHERE `whatIsThis` = '1721478796imagepngcd5bd27555eed701973bf72e77d8226f.png.webp';"); 
    $get_fragile->execute(); 
    $row = $get_fragile->fetch();
    ...
    if ($row["program"] == $meIam) {
        ...
        $set_fragile_while = "UPDATE `room-home` SET `coordsW` = `coordsW` + '$moveFragileW', `coordsD` = `coordsD` + '$moveFragileD', `coordsH` = 0, `tick` = `tick` + 1, `minusPlusW` = '$mpMoveW', `mpChange` = '$mpChange' WHERE `whatIsThis` = '1721478796imagepngcd5bd27555eed701973bf72e77d8226f.png.webp';"; 
     
        }
        /*    if ($FragileH > 20000 || $FragileH < -20000) { 
                $set_fragile_while = "UPDATE $room SET `coordsW` = `coordsW` + '$moveFragileW', `coordsD` = `coordsD` + '$moveFragileD', `coordsH` = 10000, `tick` = `tick` + 1, `minusPlusW` = '$mpMoveW', `mpChange` = 0 WHERE `whatIsThis` = '1721478796imagepngcd5bd27555eed701973bf72e77d8226f.png.webp' AND `program` = '$meIam';"; }
            if ($FragileD > 60 || $FragileD < -60) {
                $set_fragile_while = "UPDATE $room SET `coordsW` = `coordsW` + '$moveFragileW', `coordsD` = 0, `coordsH` = `coordsH` + '$moveFragileH', `tick` = `tick` + 1, `minusPlusW` = '$mpMoveW', `mpChange` = 0 WHERE `whatIsThis` = '1721478796imagepngcd5bd27555eed701973bf72e77d8226f.png.webp' AND `program` = '$meIam';"; }
        */
