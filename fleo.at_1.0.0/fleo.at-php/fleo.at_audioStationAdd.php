...
<div style="float:left;width:100%;max-width:500px;padding:4px;background:#ffffff6f;">
<div>
...
<p><div><label for="buildhtml" class="form">html </label>
...
<div style="float:left;width:100%;max-width:500px;min-width:200px;padding:4px;background:#47ccf06f;">
...
<div style="float:left;width:100%;max-width:500px;padding:4px;background:#ffffff6f;font-size:30px;">Hit the red button to send your recording.</div>
