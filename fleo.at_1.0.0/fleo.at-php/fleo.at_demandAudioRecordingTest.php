...
<div style="float:left;width:100%;max-width:500px;padding:4px;background:#47ccf06f;font-size:30px;">Hit the red button to send, write and translate your recording.</div>
<div style="float:left;width:100%;max-width:500px;padding:4px;background:#ffffff6f;font-size:30px;"><button id="recordInterval" style="font-size:30px;display:none;">Interval recording</button><button id="recordIntervalStop" style="font-size:30px;display:none;">Interval recording off</button><button id="newbtn" class="newButton" style="font-size:30px;display:none;">New</button></div>
<div style="float:left;width:100%;max-width:500px;padding:4px;background:#47ccf06f;font-size:30px;"><div id="webcamSelfDifferent" style="width:100%;"></div></div>
<div style="float:left;width:100%;max-width:500px;padding:4px;background:#ffffff6f;font-size:30px;"><div id="audioStationSpeechSummary"></div></div>
</div>
</form>
